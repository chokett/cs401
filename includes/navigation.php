...
<ul>
<!--	<li <?php if($thisPage=='Registration') { echo 'id="currentpage"'; } ?>><a href="index.php">Registration</a></li> -->
      <li <?php if($thisPage=='Home') { echo 'id="currentpage"'; } ?>><a href="welcome.php">Home</a></li>
      <li <?php if($thisPage=='Blog') { echo 'id="currentpage"'; } ?>><a href="blog.php">Blog</a></li>
